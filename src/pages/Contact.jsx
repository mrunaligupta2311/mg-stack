  ...
  return (
    <main className="overflow-hidden bg-white">
      ...
      <section className="relative px-6 pb-28 pt-32 lg:px-8">
        <div className="absolute -left-40 top-0 h-[420px] w-[420px] rounded-full bg-[#FFD8EA] opacity-40 blur-[160px]" />

        <div className="absolute right-[-120px] top-20 h-[420px] w-[420px] rounded-full bg-[#F56FA6] opacity-10 blur-[170px]" />
        ...
        <div className="relative mx-auto max-w-7xl">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="inline-flex rounded-full border border-[#FFD8EA] bg-white px-5 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-[#E94F92] shadow-sm">
              Contact
            </span>

            <h1 className="mt-8 text-5xl font-black leading-[1.05] tracking-[-0.04em] text-neutral-950 lg:text-7xl">
              Let's Build
      ...
      <section className="bg-[#FCF7FA] px-4 py-20 sm:px-6 lg:px-8">
